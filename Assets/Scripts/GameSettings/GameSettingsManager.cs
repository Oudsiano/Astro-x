...
namespace GameSettings
{
    public class GameSettingsManager
    {
        ...
        private static readonly SoundVolumeType[] VolumeTypes = new[] { SoundVolumeType.Effects, SoundVolumeType.Music };
        
        private readonly Dictionary<SoundVolumeType, Action<float>> _soundVolumeListeners = new();
        private readonly List<SoundSettings> _soundSettings;
        
        public GameSettingsManager()
        {
            foreach (var volumeType in VolumeTypes)
            {
